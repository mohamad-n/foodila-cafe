        ...
        {current?.items.map((item) => (
          ...
          >
            <div className="w-card-img">
              {item.images[0] ? (
                <MenuPhoto image={item.images[0]} alt={item.name.fa} sizes="(max-width:520px) 100vw, 520px" />
              ) : (
                <div className="ph" />
              )}
            </div>
            <div className="w-card-body">
              ...
              <div className="w-meta">
                ...
                {typeof item.calories === "number" ? <span>{faNum(item.calories)} کالری</span> : null}
